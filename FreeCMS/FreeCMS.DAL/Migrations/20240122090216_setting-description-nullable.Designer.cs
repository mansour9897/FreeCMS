...
namespace FreeCMS.DAL.Migrations
{
    ...
    [Migration("20240122090216_setting-description-nullable")]
    partial class settingdescriptionnullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreeCMS.DomainModels.System.Menu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FreeCMS.DomainModels.System.MenuItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FreeCMS.DomainModels.System.ViewObject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FreeCMS.DomainModels.System.MenuItem", b =>
                {
                    b.HasOne("FreeCMS.DomainModels.System.Menu", "Menu")
                        .WithMany("MenuItems")
                        .HasForeignKey("MenuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FreeCMS.DomainModels.System.MenuItem", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
